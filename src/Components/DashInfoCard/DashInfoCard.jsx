  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const withdrawalResponse = await fetch(`${djangoHostname}/api/withdraw/withdraw/`, {
          headers: {
        ...
        <div className="row gy-3">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            <div className="rounded-3 px-3 py-4 user-bal">
              ...
              <h5 className="fw-bold mt-3">NGN {dashboardData.userBalance}</h5>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12">
            <div className="rounded-3 px-3 py-4 depo">
              ...
              <h5 className="fw-bold mt-3">NGN {dashboardData.totalAmountTopUp}</h5>
              <span>Deposit</span>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 col-sm-12">
            <div className="rounded-3 px-3 py-4 take w-100">
              ...
              <h5 className="fw-bold mt-3">NGN {dashboardData.totalAmountWithdraw}</h5>
