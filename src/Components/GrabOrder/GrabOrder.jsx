...
const GrabOrder = () => {
  ...
  const handleGrabClick = () => {
    ...
    if (user_level === "VIP1" && orderCount === 0 && balance < 700){
        setMessageF("Forbidden, contact Administrator");
        // setMessageF(t("forbidden_contact_administrator"));
         setShowModalF(true);
      } 
      else if (user_level === "VIP2" && orderCount === 0 && balance < 9500) {
   
      setMessageF("Forbidden, contact Administrator");
     // setMessageF(t("forbidden_contact_administrator"));
      setShowModalF(true);
      
      }else if (user_level === "VIP2" && orderCount === 1 && balance < 3500) {
   
      setMessageF("Top up NGN 3500 to Continue Grabbing");
     // setMessageF(t("forbidden_contact_administrator"));
      setShowModalF(true);
      
    } else if (user_level === "VIP3" && orderCount === 0 && balance < 15500) {
      setMessageF("Forbidden Contact Administrator");
      setShowModalF(true);

    } else if (user_level === "VIP3" && orderCount === 1 && balance < 25350) {
      setMessageF("Top up NGN 25350 to start Grabbing");
      //setMessageF(t("Top_up_$120"));

      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 2 && balance < 44500) {
       setMessageF("Top up NGN 44500 to start Grabbing");
      //setMessageF(t("Top_up_$200"));z

      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 3 && balance < 78600) {
      setMessageF("Top up NGN 78600 to start Grabbing");
      //setMessageF(t("Top_up_$500"));

      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 4 && balance < 109320) {
      setMessageF("Top up NGN 109320 to start Grabbing");
      //setMessageF(t("Top_up_$900"));

      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 5 && balance < 170450) {
       setMessageF("Top up NGN 170450 to start Grabbing");
      //setMessageF(t("Top_up_$1200"));

      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 6 && balance < 250000) {
      setMessageF("Top up NGN 250000 to start Grabbing");
      //setMessageF(t("Top_up_$1500"));
      
      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 7 && balance < 370400) {
      setMessageF("Top up NGN 370400 to start Grabbing");
      //setMessageF(t("Top_up_$2200"));
      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 8 && balance < 435200) {
       setMessageF("Top up NGN 435200 to start Grabbing");
      //setMessageF(t("Top_up_$3000"));
      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 9 && balance < 510550) {
       setMessageF("Top up NGN 510550 to start Grabbing");
      //setMessageF(t("Top_up_$3500"));
      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 10 && balance < 530400) {
      setMessageF("Top up NGN 530400 to start Grabbing");
      //setMessageF(t("Top_up_$3950"));
      setShowModalF(true);
    } else if (user_level === "VIP3" && orderCount === 11 && balance < 610000) {
       setMessageF("Top up NGN 610000 to start Grabbing");
            ...
            <div className="card parent-card rounded-5 p-4 border-0">
              ...
              <div className="text-start">
                ...
                <div>
                  ...
                  NGN <span className="display-1 fw-bold">{balance}</span>
                  </p>
                </div>
              ...
              <div className="px-4">
                <p className="commission fw-bold fs-1">NGN {commission1}</p>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-md-12 col-sm-12">
            <div className="card parent-card h-50 border-0 rounded-5">
              <div className="card parent-card rounded-5 p-4 border-0">
                ...
                <div className="px-4">
                  <p className="commission fw-bold fs-1">NGN {commission2}</p>
                </div>
              </div>
            </div>
          </div>
