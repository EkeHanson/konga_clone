...
const Modal1 = ({ show, handleClose, user_level, amount, balance, orderCounts}) => {
  ...
  function amount_order(){
    if(user_level === "VIP1" && orderCounts == 0){
      return  700
    }
    if(user_level === "VIP1" && orderCounts == 1){
      return  800
    }
    if(user_level === "VIP1" && orderCounts == 2){
      return  1000
    }
    ...
    if (balance >= amount) {
      ...
      try {
        ...
        if (userLevel === "VIP2" && orderCount === 1) {
          setFlashMessage("Top up NGN 3500 for the next Order");
    ...
    <div className="modal-overlay">
      <div className="modal-content py-5">
        ...
        <div className="d-flex justify-content-between px-4">
          <p className="pro-amount fw-bold fs-3">NGN {}</p>
        ...
        <div className="d-flex justify-content-between my-0 mx-2">
          <div>
            ...
            <p className="total-amount text-start fs-4 fw-bold mt-0">NGN {amount_order()}</p>
          </div>
          <div>
            <h4 className="fw-bold commi">Commision</h4>
            <h4 className="fw-bold commi text-end"> NGN {commission_order()}</h4>
          </div>
        </div>
