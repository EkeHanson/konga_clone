...
const WithdrawDash = () => {
  ...
  try {
    const token = localStorage.getItem("token");
        const response = await axios.get(`${djangoHostname}/api/withdraw/withdraw/`, {
          headers: {
      ...
      await fetch(`${djangoHostname}/api/accounts/users/${userId}/`, {
        ...
        body: JSON.stringify({
          unsettle: newUnsettle,
            ...
            await fetch(`${djangoHostname}/api/withdraw/withdraw/${withdrawId}/`, {
              method: "PATCH",
              headers: {
                Authorization: `Token ${token}`,
                "Content-Type": "application/json",
  ...
  try {
    const token = localStorage.getItem("token");
    await axios.delete(`${djangoHostname}/api/withdraw/withdraw/${withdrawalID}`, {
      headers: {
        Authorization: `Token ${token}`,
      },
    });
