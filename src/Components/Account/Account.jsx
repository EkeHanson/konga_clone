...
/>
        ...
        <div className="col-lg-9 px-0">
          <div className="main-content pt-5 pb-5">
            ...
            <div className=" text-center rounded-5 w-100 balance-card mx-auto">
              <div className="container-fluid">
                ...
                <div className="row align-items-center justify-content-center">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-12 text-light">
                    ...
                    <p className="fw-bold text-center display-6">NGN {balance}</p>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-12 text-light">
                    ...
                    <p className="fw-bold display-6 text-start text-center ">
                      NGN {unsettle}
                    </p>
                  </div>
